...
build()
{
    ...
    echo "[INIT] read deployment config files inside -> ${f}/.deployments.gitlab-ci.yml for branch ${gitBranch}"
    export DNS=$(ConfigUtils.getValueFromConfig "${f}/.deployments.gitlab-ci.yml" ${gitBranch})
